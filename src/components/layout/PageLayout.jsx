...
export default function PageLayout({ children }) {
  ...
  return (
    <div className="flex h-screen w-full bg-[#030305] text-zinc-100 font-['Outfit'] overflow-hidden selection:bg-emerald-500/30">
      ...
      {/* DESKTOP SIDEBAR 
        Added 'hidden md:flex' so it completely disappears on mobile screens 
      */}
      <motion.aside 
        initial={false}
      ...
      {/* MOBILE FLOATING GLASS MENU 
        Visible only on mobile (md:hidden). Uses backdrop-blur for the glass effect.
      */}
            ...
            >
              {({ isActive }) => (
                <>
                  ...
                  {/* Text only appears when the tab is active */}
                  {isActive && (
